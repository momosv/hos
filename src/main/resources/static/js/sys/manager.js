...
function saveOrUpdate() {
    if( $("#hiddenId").val()==""){
        ...
        $.ajax({url:"/sys/updateChildManager",
            type:"post",
            data:{
               id: $("#hiddenId").val(),
